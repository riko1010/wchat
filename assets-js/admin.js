...
function AdminLogin(email,password) {
    ...
    AdminLoginRequest = $.ajax({
      ...
      devlog(item.name);  
      $('.chatfileslist').append('<span class="d-inline">djdbd</span><span class="d-inline list-group-item list-group-item-action " aria-current="true"> <div class="d-flex w-100 justify-content-between"> <h5 class="mb-1">'+item.name+'</h5> <small>'+item.dateadded+'</small> </div><p class="mb-1">'+item.dirname+'</p><small> <input type="email" class="AdminChatfileLink form-control" value="'+item.url+'" readonly></small></span>');
