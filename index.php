...
<?=date('M d, Y h:i:sa', time()); ?>
    ...
    <footer>
      <?php var_dump ( (!$app->NPagination == null) ?: $app->NPagination );?> <a href="sitemap.xml" data-bs-toggle="modal" data-bs-target="#sitemapModal">sitemap</a> | from <a target="_blank" href="https://github.com/itxshakil/Whatsapp-backup-Viewer">Shakil Alam on Github</a>
    </footer>
